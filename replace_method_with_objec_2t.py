...
class Container_B:
    ...
    def get_weekday_discount(self, base_discount, current_day):
        # ... long computation for weekday discount.
        # ... long result preparation.
        # ...

        discount_final = base_discount + product_discount * current_day
        return discount_final

    def get_weekend_discount(self, base_discount):
        # ... long computation for weekend days discount.
        # ... long result preparation.
        # ...

        discount_final = base_discount + product_discount + ...
        # ...
        return discount_final

    def calculate_final_discoutn(self, weekday_discount, weekend_discount, temp_b, temp_v):
        pass


class Container_Dicsount:
    def __init__(self):
        base_discount = 20
        weekday_discount = 0
        weekend_discount = 0
    ...
    def get_weekday_discount(self, current_day):
        # ... long computation for weekday discount.
        # ... long result preparation.
        # ...
    ...
    def calculate_final_discoutn(self):
        pass
